...
<div class="container-fluid">
    <div class="card p-4">
        <div class="d-flex justify-content-between mb-3">
            <div>
                <h4 class="fw-bold mb-3">Super Admin List</h4>
                @isset($email)
            ...
            <div>
                <form action="{{ url('/admin/superAdmins/search/') }}" method="GET">
                    @csrf
                ...
                <form class="mt-3" action="{{ url('/admin/superAdmins/search/date') }}" method="get">
                    @csrf
                    <div class="d-flex">
                        <div>
        ...
        <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                            <img src="{{ asset('assets/img/profile/'.$user->profile) }}" width="50px" height="50px" class="rounded-circle" alt="">
                            @endif
                        </td>
                        <td>
            ...
            @if (!$users->count())
                <div class="bg-light text-center py-3 my-2">
                    ...
                    <p>Go To <a href="{{ url('/admin/superAdmins/') }}" class="btn btn-sm btn-primary">Previous Page</a></p>
                </div>
            @endif
        </div>
    </div>
